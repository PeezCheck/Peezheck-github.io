            ...
            <div class="container">
                <div class="row" style="width:50%;margin-top:5%;margin-left:8%">
                    <div class="col border text-center p-5 m-1">
                        <h1 class="display-5">Şifremi Unuttum</h1><br />
                        <form action="forgotpassword.php" method="POST">
                            <div class="form-group" style="width: 250px;margin-left:29%">

                                Kullanıcı Adı <input type="text" class="form-control" name="fpasswordkadi" required>
                            </div>
                            <div class="form-group" style="width: 250px;margin-left:29%">

                                E-mail <input type="text"  class="form-control" name="fpasswordemail">
                            </div> <br />
                            
                            <input type="submit" class="btn btn-primary px-5 btn-block" style="width: 250px;margin-left:29%" value="Sıfırla" name="fpasswordsıfırlabtn">
